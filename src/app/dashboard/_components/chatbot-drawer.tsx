...
export default function ChatbotDrawer() {
  ...
  function sendMessage(message: string) {
    ...
    setConversation((prev) => [...prev, newMesage]);
                ...
                >
                  <div
                    className={cn("flex flex-col w-full", {
                      "bg-primary/20 text-primary px-5 py-2 rounded-3xl rounder-br-md w-fit max-w-3/4":
                        message.role === "user",
                    })}
                  >
                    {message.role === "model" && (
                    ...
                    {message.role === "model" ? (
                      <div className="response-ai">
                        {message.parts.map((part, indexPart) => (
                          <div key={`response-ai-key-${index}-${indexPart}`}>
                            {part.thought ? (
                              <Collapsible>
